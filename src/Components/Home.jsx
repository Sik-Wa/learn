...
const Home = () => {
  return (
    <section className="w-full flex mt-10 min-h-screen px-2 md:px-10 py-6 ">
      <div className=" w-full flex flex-col items-center justify-center p-4">
        ...
        <div className=" w-full grid grid-cols-1 md:grid-cols-4 items-center justify-center mt-6 gap-6">
          ...
          <div style={{backgroundImage:`url(${image})`}} className=" w-full bg-cover object-cover bg-center h-96
           rounded-[40px] group relative shadow shadow-[#d47a54] overflow-hidden" >
          <div className=" w-full flex flex-col absolute -bottom-full p-4 group-hover:bottom-0 
          delay-150 duration-500 bg-[#d47a54] overflow-hidden">
             <p className=" text-lg font-bold ">Lorem ipsum dolor sit amet.</p>
          ...
          <div style={{backgroundImage:`url(${image1})`}} className=" w-full bg-cover object-cover bg-center h-96
           rounded-[40px] group relative shadow shadow-[#d47a54] overflow-hidden" >
          <div className=" w-full flex flex-col absolute -bottom-full p-4 group-hover:bottom-0 
          delay-150 duration-500 bg-[#d47a54] overflow-hidden">
             <p className=" text-lg font-bold ">Lorem ipsum dolor sit amet.</p>
          ...
          <div style={{backgroundImage:`url(${image2})`}} className="  w-full bg-cover object-cover bg-center h-96
           rounded-[40px] group relative shadow shadow-[#d47a54] overflow-hidden" >
          <div className=" w-full flex flex-col absolute -bottom-full p-4 group-hover:bottom-0 
          delay-150 duration-500 bg-[#d47a54] overflow-hidden">
             <p className=" text-lg font-bold ">Lorem ipsum dolor sit amet.</p>
